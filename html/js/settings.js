...
$(document).on('click', '.settings-app-tab', function(e){
    ...
    if (PressedTab == "background") {
        ...
        MI.Phone.Settings.OpenedTab = PressedTab;
    } else if (PressedTab == "format") {
        MI.Phone.Animations.SoldanSaga(".format-custom");
        ...
        $.post("http://almez-phonev2/UpdateAvailableStatus", JSON.stringify({available: b}),
            function () {
...
SettingsDarkmode = function() {
    if (MI.Phone.Data.Darkmode) {
        ...
        $(".hava-durumu").css({"background": "rgb(60,62,68)"});
        $(".hava-durumu").css({"background": "linear-gradient(0deg, rgba(60,62,68,1) 0%, rgba(14,16,20,1) 100%)"});
        $(".saat-widget").css({"background": "rgb(60,62,68)"});
        $(".saat-widget").css({"background": "linear-gradient(0deg, rgba(60,62,68,1) 0%, rgba(14,16,20,1) 100%)"});
        ...
        $(".hava-durumu").css({"background": "rgb(206,70,64)"});
        $(".hava-durumu").css({"background": "linear-gradient(0deg, rgba(206,70,64,1) 0%, rgba(225,159,76,1) 100%)"});
        $(".saat-widget").css({"background": "rgb(206,70,64)"});
        $(".saat-widget").css({"background": "linear-gradient(0deg, rgba(206,70,64,1) 0%, rgba(225,159,76,1) 100%)"});
        MI.Phone.Settings.Background = "background-1";
        // $(".phone-app-footer").css({"background": "rgb(248, 248, 248)"});
    }
}
...
$(document).on('click', '#accept-background', function(e){
    ...
    $.post('http://almez-phonev2/SetBackground', JSON.stringify({
...
$(document).on('click', '#cancel-custom-format', function(e){
    e.preventDefault();

    MI.Phone.Animations.OptionDown(".format-custom", 200, -23);
});

$(document).on('click', '#accept-custom-format', function(e){
    e.preventDefault();
    console.log("Basardin kardo")
    MI.Phone.Animations.OptionDown(".format-custom", 200, -23);
});
...
$(document).on('click', '#accept-profilepicture', function(e){
    ...
    $.post('http://almez-phonev2/UpdateProfilePicture', JSON.stringify({
