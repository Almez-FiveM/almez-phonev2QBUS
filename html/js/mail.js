...
MI.Phone.Functions.SetupMails = function(Mails) {
    ...
    $("#mail-header-text").html(MI.Phone.Data.PlayerData.Name);
    $("#mail-header-mail").html(MI.Phone.Data.PlayerData.Name+"@icloud.com");
...
MI.Phone.Functions.RefreshAdverts = function(Adverts) {
    $("#advert-header-name").html("@"+MI.Phone.Data.PlayerData.Name+" | "+MI.Phone.Data.PlayerData.charinfo.phone);
